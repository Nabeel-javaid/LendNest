...
import "../contracts/LendNestV2MarketForwarder_G1.sol";

import "./tokens/TestERC20Token.sol";
import "../contracts/LendNestV2Context.sol";
...
contract MarketLiquidityRewards_Test is Testable, MarketLiquidityRewards {
    ...
    function setUp() public {
        marketOwner = new MarketLiquidityUser(address(LendNestV2), (this));
        borrower = new MarketLiquidityUser(address(LendNestV2), (this));
        lender = new MarketLiquidityUser(address(LendNestV2), (this));
        LendNestV2Mock(LendNestV2).__setMarketRegistry(address(marketRegistry));
    ...
    function test_claimRewards() public {
        ...
        LendNestV2Mock(LendNestV2).setMockBid(mockBid);
...
contract MarketLiquidityUser is User {
    ...
    constructor(address _LendNestV2, MarketLiquidityRewards _liquidityRewards)
        User(_LendNestV2)
    {
...
contract LendNestV2Mock is LendNestV2Context {
    Bid mockBid;
