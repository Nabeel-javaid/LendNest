...
import "../contracts/LendNestV2Storage.sol";
...
import { LendNestASMock } from "../contracts/mock/LendNestASMock.sol";
...
contract MarketRegistry_Test is Testable {
    ...
    LendNestV2Mock LendNestV2;
    MarketRegistry_Override marketRegistry;

    LendNestASMock LendNestASMock;
    ...
    function setUp() public {
        LendNestV2 = new LendNestV2Mock();
        marketRegistry = new MarketRegistry_Override();

        LendNestASMock = new LendNestASMock();

        marketRegistry.initialize(LendNestASMock);
        ...
        LendNestV2.setMarketRegistry(address(marketRegistry));
...
contract MarketRegistryUser is User {
    ...
    constructor(address _LendNestV2, address _marketRegistry) User(_LendNestV2) {
