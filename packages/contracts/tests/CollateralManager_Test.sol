...
import "../contracts/mock/LendNestV2SolMock.sol";
...
contract CollateralManager_Test is Testable {
    ...
    LendNestV2_Mock LendNestV2Mock;
    ...
    function setUp() public {
        ...
        LendNestV2Mock = new LendNestV2_Mock();
        borrower = new User();
        lender = new User();
        liquidator = new User();
    ...
    function test_initialize_valid() public {
        ...
        tempCManager.initialize(address(eBeacon), address(LendNestV2Mock));

        address managerLendNestV2 = address(tempCManager.LendNestV2());
        assertEq(
            managerLendNestV2,
            address(LendNestV2Mock),
    ...
    function test_deposit() public {
        ...
        LendNestV2Mock.setBorrower(address(borrower));
    ...
    function test_deployAndDeposit_not_backed() public {
        ...
        vm.prank(address(LendNestV2Mock));
    ...
    function test_withdraw_external_invalid_bid_state() public {
        ...
        LendNestV2Mock.setGlobalBidState(BidState.PENDING);
    ...
    function test_withdraw_external_invalid_bid_state_liquidated() public {
        ...
        LendNestV2Mock.setGlobalBidState(BidState.LIQUIDATED);
    ...
    function test_withdraw_external_state_paid() public {
        ...
        LendNestV2Mock.setBorrower(address(borrower));
        LendNestV2Mock.setGlobalBidState(BidState.PAID);
    ...
    function test_lenderClaimCollateral_invalid_sender() public {
        ...
        LendNestV2Mock.setGlobalBidState(BidState.CLOSED);
    ...
    function test_lenderClaimCollateral() public {
        ...
        LendNestV2Mock.setLender(address(lender));
...
*/
    ...
    function test_commit_collateral_single_not_LendNest() public {
        uint256 bidId = 0;
    ...
    function test_commit_collateral_invalid_bid() public {
        ...
        LendNestV2Mock.setBorrower(address(0));
