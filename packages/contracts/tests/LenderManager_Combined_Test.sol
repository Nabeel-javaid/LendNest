...
contract LenderManager_Test is Testable, LenderManager {
    ...
    LenderCommitmentTester mockLendNestV2;
    ...
    function setUp() public {
        mockLendNestV2 = new LenderCommitmentTester();

        marketOwner = new LenderManagerUser(
            address(mockLendNestV2),
            address(this)
        );
        borrower = new LenderManagerUser(address(mockLendNestV2), address(this));
        lender = new LenderManagerUser(address(mockLendNestV2), address(this));
...
contract LenderManagerUser is User {
    ...
    constructor(address _LendNestV2, address _lenderManager) User(_LendNestV2) {
...
contract LenderCommitmentTester is LendNestV2Context {
