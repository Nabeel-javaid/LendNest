...
// Contracts
import "./EAS/LendNestAS.sol";
import "./EAS/LendNestASResolver.sol";
    ...
    LendNestASResolver
{
    ...
    function initialize(LendNestAS _LendNestAS) external initializer {
        LendNestAS = _LendNestAS;

        lenderAttestationSchemaId = LendNestAS.getASRegistry().register(
            "(uint256 marketId, address lenderAddress)",
            this
        );
        borrowerAttestationSchemaId = LendNestAS.getASRegistry().register(
        ...
        )
    {
        ...
        bytes32 uuid = LendNestAS.attest(
            _stakeholderAddress,
        ...
        )
    {
        ...
        bytes32 uuid;
        {
            ...
            uuid = LendNestAS.attestByDelegation(
                _stakeholderAddress,
                _attestingSchemaId, // set by the modifier
                _expirationTime,
                0,
    ...
    function _revokeStakeholderViaDelegation(
        ...
        //        LendNestAS.revokeByDelegation(uuid, attestor, _v, _r, _s);
    }
    ...
    function _isVerified(
        ...
        if (_attestationRequired) {
            isVerified_ =
                ...
                LendNestAS.isAttestationActive(
