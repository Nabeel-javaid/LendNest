...
// Contracts
import "../LendNestV2MarketForwarder_G1.sol";
...
contract LenderCommitmentForwarder_G1 is LendNestV2MarketForwarder_G1 {
     ...
     * @param tokenAmount The amount of the asset being committed.
     * @param bidId The bid id for the loan from LendNestV2.
     */
    ...
    constructor(address _protocolAddress, address _marketRegistry)
        LendNestV2MarketForwarder_G1(_protocolAddress, _marketRegistry)
    {}
     ...
     * @return bidId The ID of the loan that was created on LendNestV2
     */
