...
contract CommitmentRolloverLoan is ICommitmentRolloverLoan {
    ...
    constructor(address _LendNestV2, address _lenderCommitmentForwarder) {
    ...
    function rolloverLoan(
        ...
        IERC20Upgradeable lendingToken = IERC20Upgradeable(
            LendNest_V2.getLoanLendingToken(_loanId)
        );
        ...
        // Approve LendNestV2 to spend funds and repay loan
        lendingToken.approve(address(LendNest_V2), fundsReceived);
        LendNest_V2.repayLoanFull(_loanId);
