...
contract ReputationManager is IReputationManager, Initializable {
     ...
     */
    function initialize(address _LendNestV2) external initializer {
    ...
    function updateAccountReputation(address _account) public override {
        uint256[] memory activeBidIds = LendNestV2.getBorrowerActiveLoanIds(
            _account
        );
